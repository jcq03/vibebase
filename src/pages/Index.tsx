    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <nav className="border-b border-gray-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-gray-900">Code Vibez Tool Kit</span>
          </div>
          <div className="flex items-center gap-4">
            <Button variant="ghost" onClick={() => navigate("/auth")} className="text-gray-900 hover:text-gray-900 hover:bg-gray-100">
              Sign in
            </Button>
            <Button onClick={() => navigate("/auth")} className="bg-gray-900 text-white hover:bg-gray-800">
              Get started
            </Button>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-20 md:py-32">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="text-sm text-gray-600">
              Value: <span className="line-through">£99</span> — get it for <span className="font-bold text-gray-900">£29</span> for a full year
            </div>
            <Button 
              size="lg" 
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="inline-block px-4 py-2 bg-gray-900/10 text-gray-900 rounded-full text-sm font-medium mb-12">
            How It Works
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                {steps.map((step, index) => (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <span className={`text-2xl font-bold ${step.active ? "text-gray-900" : "text-gray-400"}`}>
                        {step.number}
                      </span>
                      <div className="flex-1">
                        <h3 className={`text-xl font-bold mb-2 ${step.active ? "text-gray-900" : "text-gray-400"}`}>
                          {step.title}
                        </h3>
            ...
            <div className="relative lg:sticky lg:top-24">
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-gray-100 via-gray-50 to-white border-2 border-gray-200 flex items-center justify-center">
                <div className="text-center space-y-4 p-8">
                  <div className="w-24 h-24 rounded-2xl bg-gray-100 backdrop-blur-sm mx-auto flex items-center justify-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="border-gray-200 hover:border-gray-900/50 transition-colors bg-white">
                <CardContent className="pt-6 space-y-4">
                  ...
                  <div className="flex items-center gap-3 pt-4">
                    <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center font-bold text-gray-900 text-sm">
                      {testimonial.avatar}
                    </div>
                    <div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <Card className="max-w-lg mx-auto border-2 border-gray-900 bg-white">
            <CardHeader className="text-center pb-8 space-y-2">
              <CardTitle className="text-3xl text-gray-900">Pro Builder</CardTitle>
              <div className="mt-4">
            ...
            <CardContent className="space-y-4">
              ...
              <Button className="w-full mt-8 bg-gray-900 text-white hover:bg-gray-800" size="lg" onClick={() => navigate("/auth")}>
                Get Started
              </Button>
            </CardContent>
          </Card>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-center md:text-left">
              <div className="flex items-center gap-2 justify-center md:justify-start mb-2">
                ...
                <h3 className="text-xl font-bold text-gray-900">Code Vibez Tool Kit</h3>
              </div>
            ...
            <div className="flex gap-4">
              <Button variant="ghost" size="icon" className="rounded-full text-gray-900 hover:bg-gray-100" asChild>
